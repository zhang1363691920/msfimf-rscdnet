...
class CDM(nn.Module):
    ...
    def forward(self, input1, input2):     # torch.size([1, 3, 256, 256])
        ...
        input1_fh3 = self.sam(input1_f3) * input1_f3  # c = 128
        ...
        input2_fh3 = self.sam(input2_f3) * input2_f3
        ...
        output3 = torch.cat((input1_fh3, input2_fh3), dim=1)  # torch.Size([1, 256, 32, 32])
