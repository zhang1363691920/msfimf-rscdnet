...
from models.Ccat1 import CascadeModule
...
# from models.HRFusionBlock import HRViTFusionBlock as HRF
class CDM(nn.Module):
    '''
    网络整体结构
    '''
    def __init__(self, backbone='resnet34'):
        ...
        # self.mff = HRF(in_channels=(128, 128, 128, 128, 128),
    ...
    def forward(self, input1, input2):     # torch.size([1, 3, 256, 256])
        ...
        # output = self.mff(output)
        result = self.cat.forward(output5, output4, output3, output2, output1)  # torch.Size([1, 128, 128, 128])
